...
you can "finetune" notes with an arrow signifying one EDO step in upwards
...
Intervals can be inspected in regards to their shorthand name and
...
* In interval naming the mid symbol (~) and related symbols (like ^~, v~)
  are not implemented, because they introduce ambigouity when transposing
