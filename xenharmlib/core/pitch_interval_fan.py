...
class PitchIntervalFan(IntervalFan[IndexT, PitchIntervalT]):
    """
    Base class for all pitch intervals fans.

    In line with its Sequence superclass pitch interval fans implement
    iteration, the 'in' operator, the == operator, item retrieval with
    [], concatenation with +, repeated self-concatenation with *, searching
    with index, and len().

    Like scale types pitch interval fans also allow partitioning with
...
class PeriodicPitchIntervalFan(
    PitchIntervalFan[PeriodicIndexT, PeriodicPitchIntervalT]
):
    """
    Pitch interval fan class for periodic tunings
...
class EDPitchIntervalFan(PeriodicPitchIntervalFan[int, EDPitchInterval]):
    """
    The pitch interval fan class for equal division tunings
...
class EDOPitchIntervalFan(EDPitchIntervalFan):
    """
    The pitch interval fan class for 'equal division of the octave'
    tunings
