...
def test_guess_note_scale(pitch_indices, note_pairs):
    ...
    assert [p.pitch_index for p in note_scale_a] == pitch_indices
    assert [p.pitch_index for p in note_scale_b] == pitch_indices
