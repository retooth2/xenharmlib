...
def test_nat_index_order(divisions):
    ...
    strategy = UpwardsEnharmStrategy(notation)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            31,
            [4, 6, 13, 18, 22, 32],
            [('Cx', 0), ('^D', 0), ('F', 0), ('G', 0), ('Gx', 0), ('^C', 1)],
        ),
        (
            31,
            [0, 5, 12, 19, 20, 35],
            [('C', 0), ('D', 0), ('E#', 0), ('^G', 0), ('G#', 0), ('Cx', 1)],
        ),
        # supersharp
        (
            18,
            [4, 6, 12, 19, 20, 30],
            [('D', 0), ('^^D', 0), ('^G', 0), ('B', 0), ('^B', 0), ('^G', 1)],
        ),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [('^C', 0), ('C#', 0), ('^C#', 0), ('Cx', 0), ('^D', 0),
             ('D#', 0), ('^D#', 0), ('Dx', 0), ('E', 0), ('^E', 0),
             ('E#', 0), ('F', 0), ('^F', 0), ('F#', 0), ('^F#', 0),
             ('G', 0), ('^G', 0), ('G#', 0), ('^G#', 0), ('A', 0),
             ('^A', 0), ('^A#', 0), ('Ax', 0), ('B', 0), ('^B', 0)],
        ),
        # supersharp
        (
            18,
